@props(['color'=>'red', 'texto'=>'Mensaje DEFAULT'])

<div {{$attributes->merge(['class'=>"w-full bg-$color-300 rounded-lg"])}}>
    <div class="flex items-center justify-between px-6 py-4 ">
        ...
        <button
            class="p-1 transition-colors duration-200 transform rounded-md hover:bg-opacity-25 hover:bg-{{$color}}-600 focus:outline-none">
