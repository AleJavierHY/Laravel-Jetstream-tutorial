<div {{$attributes->merge(['class' => "w-full bg-$bgColor-300 rounded-lg"])}}>
    <div class=" flex items-center justify-between px-6 py-4">
        <div class="flex">
            ...
            <p class="mx-3">{{$slot}}</p>
            <strong class="text-{{$bgColor}}-700">{{$PruebaDeMetodo()}}</strong>
        </div>

        <button
            class="p-1 transition-colors duration-200 transform rounded-md hover:bg-opacity-25 hover:bg-{{$bgColor}}-600 focus:outline-none">
